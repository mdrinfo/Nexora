...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('dining_tables', function (Blueprint $table) {
            ...
            $table->comment('Physical tables in the restaurant');
        });
        ...
        Schema::create('qr_keys', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->comment('Physical QR plaques linked to tables and sessions');
        });
        ...
        Schema::create('sessions', function (Blueprint $table) {
            ...
            $table->comment('Dining sessions (current/previous bills). Multiple per table supported.');
        });
    }
