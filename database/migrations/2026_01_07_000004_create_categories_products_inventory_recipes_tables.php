...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->comment('Product categories');
        });
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['tenant_id', 'name']);
            $table->comment('Sellable products/dishes');
        });
        ...
        Schema::create('inventory_items', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['tenant_id', 'name']);
            $table->comment('Inventory of raw materials');
        });
        ...
        Schema::create('product_recipe_items', function (Blueprint $table) {
            ...
            $table->comment('Pivot: recipe ingredients per product for stock deduction');
        });
    }
