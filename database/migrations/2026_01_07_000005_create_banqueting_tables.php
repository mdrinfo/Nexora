...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('reservations', function (Blueprint $table) {
            ...
            $table->comment('Banquet hall reservations');
        });
        ...
        Schema::create('contracts', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->comment('Rental agreements linked to reservations');
        });
        ...
        Schema::create('inspections', function (Blueprint $table) {
            ...
            $table->text('notes')->nullable();
            $table->timestamps();
            $table->comment('Hall inspections (Etat de Lieu)');
        });
        ...
        Schema::create('inspection_images', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->comment('Images linked to inspections');
        });
    }
